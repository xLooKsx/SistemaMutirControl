 ...
 * @author Felipe
 */
public class PecaFornecedorDto {
    
    private PecaDto pecas_idPecas;
    private FornecedorDto fornecedor_cnpj;

    public PecaFornecedorDto() {
    }
     
    public PecaFornecedorDto(PecaDto pecas_idPecas, FornecedorDto fornecedor_cnpj) {
        this.pecas_idPecas = pecas_idPecas;
        this.fornecedor_cnpj = fornecedor_cnpj;
    }

    public PecaDto getPecas_idPecas() {
        return pecas_idPecas;
    }

    public void setPecas_idPecas(PecaDto pecas_idPecas) {
        this.pecas_idPecas = pecas_idPecas;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final PecaFornecedorDto other = (PecaFornecedorDto) obj;
